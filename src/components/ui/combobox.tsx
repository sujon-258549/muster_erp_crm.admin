...
export function Combobox({
  ...
  // Reset query + highlight whenever the panel opens, and focus the search box.
  React.useEffect(() => {
    if (open) {
      setQuery("")
      setHighlight(0)
  ...
  return (
    <div ref={rootRef} className={cn("relative w-full", className)}>
      <button
        ...
        aria-expanded={open}
        className={cn(
          "group flex h-9 w-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-xs transition-[color,box-shadow] outline-none",
      ...
      {open && (
        <div
          className={cn(
            "absolute left-0 right-0 z-50 mt-1 overflow-hidden rounded-md border border-input bg-popover text-popover-foreground shadow-lg",
